      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center mb-8">
          <div className="relative">
            <div className="h-16 w-16 bg-primary-100 dark:bg-primary-900 rounded-2xl flex items-center justify-center">
              <MicrophoneIcon className="h-8 w-8 text-primary-600 dark:text-primary-400" />
            </div>
            <div className="absolute -top-2 -right-2">
              <SparklesIcon className="h-5 w-5 text-secondary-500 animate-pulse" />
            </div>
          </div>
        </div>
